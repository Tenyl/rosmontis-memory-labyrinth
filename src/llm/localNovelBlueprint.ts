...
const nodeTitles: Record<MazeNodeType, readonly string[]> = {
  ...
  'emergency-combat': ['高压实验舱', '过载回声阵列', '封锁中的手术厅'],
  'encounter': ['倒流雨幕', '缺页候车室', '无字档案间'],
  'dilemma': ['两种温度的门', '不可兼得的病历', '记忆蜕变室'],
  'safehouse': ['静默玻璃温室', '暖光休息站', '呼吸校准室'],
...
const nodeDescriptions: Record<MazeNodeType, string> = {
  ...
  'emergency-combat': '高威胁残响裹挟额外护盾和过载干扰，要求更谨慎地分配巨剑。',
  'encounter': '场景缺失了一段因果，只留下可供迷迭香选择的认知断面。',
  'dilemma': '两段记忆要求被同时承认，选择会明确交换当前属性与后续收益。',
  'safehouse': '稳定信号在此短暂聚合，可以重新校准记忆与现实的边界。',
