...
export default function LogPage() {
  ...
  return (
    <section className="route-page log-route" aria-labelledby="log-page-title">
      <PageHeader code="05" title="行动记录" description="按时间追溯章节、玩家指令、检定、状态变化、节点解锁与情报入库，保留每个结果的原始剧情来源。" meta={`${String(actionLog.length).padStart(2, '0')} RECORDS / CHAPTER 01`} actions={<span className="log-integrity"><ShieldCheck size={16} weight="fill" aria-hidden />记录完整性 100%</span>} />
