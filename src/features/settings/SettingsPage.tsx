...
export default function SettingsPage() {
  ...
  return (
    <section className="route-page settings-route" aria-labelledby="settings-page-title">
      <PageHeader id="settings-page-title" code="06" title="系统设置" description="调整信息密度、叙事速度、动效、字号和辅助显示。所有偏好只保存在当前浏览器。" meta="LOCAL PROFILE / SECURE" actions={<span className="settings-saved"><CheckCircle size={16} weight="fill" aria-hidden />偏好已保存</span>} />
